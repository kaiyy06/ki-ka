...
export default function Letter() {
    ...
    return (
        <section className="letter section-sm" id="letter" ref={ref}>
            <div className="container">
                ...
                >
                    ...
                    <p className="letter-text">
                        ...
                        I never expected to find. Every moment with you feels
                        like a beautiful chapter in our forever story.
                    </p>
                    <motion.div
